...
script and removes customer-specific references from documentation and examples.
Key improvements include fixing debug mode, changing default behavior to list
mode, and adding quiet mode support.
