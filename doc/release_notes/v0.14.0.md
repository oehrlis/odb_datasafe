...
- **Phase 2**
  - `bin/ds_target_update_credentials.sh`, `bin/ds_target_update_connector.sh`, and `bin/ds_target_update_tags.sh` now use the same shared collection, regex validation, and no-match handling flow.
