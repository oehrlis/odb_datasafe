...
- Added chmod guidance when updating the embedded payload in `doc/database_prereqs.md`.
...
- Usage now exits non-zero on parameter errors in `ds_target_update_connector.sh`.
