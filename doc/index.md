...
Latest release: [v0.12.1](release_notes/v0.12.1.md)
...
- **[v0.12.1 Release Note](release_notes/v0.12.1.md)** - Connector check-all validation and OCI password policy fixes
